...
from django_cassandra_fake.utils import get_cassandra_connections
...
class Command(MakeMigrationsCommand):
    ...
    def handle(self, *args, **options):
        """
        Pretend django_cassandra_fake to be dummy database backend
        ...
        try:
            ...
            self._change_cassandra_engine_name('django_cassandra_fake')
